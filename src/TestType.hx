// Comes from the haxe compiler test suite: haxe/tests/unit/src/unti/TestType.hx
...
class TestType extends Test {
    ...
    inline function inlineTest1<T>(map:Array<T_renamed>) {
        map[0];
    }
    ...
    @:generic static function gf1<T>(a:T_renamed) {
        return a;
    }
...
typedef TypedefToStringMap<T> = Map<String,T_renamed>
