...
#if !haxe_ver
        // Precedence tests
        b = 1 % 2 is Int;     // 4.2: 17-25 : Bool should be Int; 9-25 : Int should be Bool
        b = 1 * 2 is String;  // 4.2: 17-28 : Bool should be Int; 9-28 : Int should be Bool
        b = 1 + 2 is String;  // 4.2: 13-28 : Cannot add Int and Bool
        b = 1 >> 2 is String; // 4.2: 18-29 : Bool should be Int; 9-29 : Int should be Bool
        b = 1 & 2 is String;  // 4.2: 17-28 : Bool should be Int; 9-28 : Int should be Bool
        b = true == false is Bool;  // 4.2: compiles to true == (false is Bool)
#end
